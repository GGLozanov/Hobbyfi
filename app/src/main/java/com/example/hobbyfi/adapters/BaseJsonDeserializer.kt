...
abstract class BaseJsonDeserializer<T> : JsonDeserializer<T> {
    protected var outerJsonObject: JsonObject? = null
    ...
    protected fun deserializeJSONField(field: String, flag: DeserializeOption, jsonObject: JsonObject? = outerJsonObject): Any? {
